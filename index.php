                            ...
                            <form action="#" method="post" name="formSaisie" onsubmit="return valider(this)">
                              <div id="error"></div>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <button id="connect" name="connect" type="submit" class="btn btn-success">Connecter </button>
                                        <div class="form-group">
                                            <label>Vous n'etes pas encore inscrit?</label>
                                            <a href="inscription.php" class="btn btn-primary">Inscrire</a>
                                        </div>
